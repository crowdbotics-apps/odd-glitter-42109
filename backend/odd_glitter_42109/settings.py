"""
Django settings for odd_glitter_42109 project.
...
ROOT_URLCONF = 'odd_glitter_42109.urls'
...
WSGI_APPLICATION = 'odd_glitter_42109.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_glitter_42109 API",
    "DESCRIPTION": "API documentation for odd_glitter_42109 App",
    "VERSION": "v1",
}
